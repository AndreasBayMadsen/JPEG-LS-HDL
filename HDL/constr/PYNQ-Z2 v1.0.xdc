...
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { en }]; #IO_L4N_T0_35 Sch=btn[1]
...
## UART
# set_property -dict {PACKAGE_PIN Y12 IOSTANDARD LVCMOS33} [get_ports uart_tx]
