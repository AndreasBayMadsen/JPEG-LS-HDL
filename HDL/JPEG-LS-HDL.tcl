...
set_property -name "top" -value "BD_camera_wrapper" -objects $obj
...
set obj [get_filesets full_system]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/constr/timing.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/constr/timing.xdc"]" -objects $obj
...
# Create 'BD_camera' fileset (if not found)
if {[string equal [get_filesets -quiet BD_camera] ""]} {
  create_fileset -constrset BD_camera
}

# Set 'BD_camera' fileset object
set obj [get_filesets BD_camera]

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constr/BD_camera_synth.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/BD_camera_synth.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets BD_camera] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constr/BD_camera_impl.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/BD_camera_impl.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets BD_camera] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "used_in" -value "implementation" -objects $file_obj
...
set_property -name "top" -value "TB_output_buffer" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# Proc to create BD BD_camera
proc cr_bd_BD_camera { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# JPEG_LS_module, cam_config, camera_multiplexer, debounce, pulse_to_edge, output_buffer, output_buffer_synchronizer, edge_to_pulse



  # CHANGE DESIGN NAME HERE
  set design_name BD_camera
  ...
  set cam_mck [ create_bd_port -dir O -type clk cam_mck ]
  set cam_pwdn [ create_bd_port -dir O -from 0 -to 0 -type data cam_pwdn ]
  set cam_res [ create_bd_port -dir O -from 0 -to 0 -type data cam_res ]
  set clk [ create_bd_port -dir I -type clk -freq_hz 125000000 clk ]
  set href [ create_bd_port -dir I -type data href ]
  set pclk [ create_bd_port -dir I -type clk -freq_hz 12000000 pclk ]
  set pixel [ create_bd_port -dir I -from 7 -to 0 -type data pixel ]
  ...
  set vsync [ create_bd_port -dir I -type data vsync ]

  # Create instance: AXI_arbiter, and set properties
  set AXI_arbiter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 AXI_arbiter ]
  set_property CONFIG.NUM_MI {2} $AXI_arbiter


  # Create instance: JPEG_LS_module, and set properties
  set block_name JPEG_LS_module
  set block_cell_name JPEG_LS_module
  if { [catch {set JPEG_LS_module [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $JPEG_LS_module eq "" } {
  ...
  # Create instance: bitstream_gpio, and set properties
  set bitstream_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 bitstream_gpio ]
  set_property -dict [list \
  ...
  # Create instance: bitstream_lsb_slice, and set properties
  set bitstream_lsb_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 bitstream_lsb_slice ]
  set_property -dict [list \
    CONFIG.DIN_FROM {31} \
    CONFIG.DIN_WIDTH {64} \
  ] $bitstream_lsb_slice
  ...
  # Create instance: bitstream_msb_slice, and set properties
  set bitstream_msb_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 bitstream_msb_slice ]
  set_property -dict [list \
    CONFIG.DIN_FROM {63} \
    CONFIG.DIN_TO {32} \
    CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: cam_clk_generator, and set properties
  set cam_clk_generator [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 cam_clk_generator ]
  set_property -dict [list \
  ...
  # Create instance: cam_config_ila, and set properties
  set cam_config_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 cam_config_ila ]
  set_property -dict [list \
  ...
  # Create instance: camera_config, and set properties
  set block_name cam_config
  set block_cell_name camera_config
  if { [catch {set camera_config [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $camera_config eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.CLK_FREQ_MHZ {100} $camera_config


  # Create instance: camera_connect_slice, and set properties
  set camera_connect_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 camera_connect_slice ]
  set_property -dict [list \
    CONFIG.DIN_FROM {3} \
    CONFIG.DIN_TO {3} \
    CONFIG.DIN_WIDTH {4} \
  ] $camera_connect_slice
  ...
  # Create instance: camera_multiplexer_0, and set properties
  set block_name camera_multiplexer
  set block_cell_name camera_multiplexer_0
  if { [catch {set camera_multiplexer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $camera_multiplexer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: control_gpio, and set properties
  set control_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 control_gpio ]
  set_property -dict [list \
    CONFIG.C_ALL_INPUTS {1} \
  ...
  if { [catch {set debounce_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.CLK_FREQ_MHZ {12} $debounce_0


  # Create instance: flag_concat, and set properties
  set flag_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 flag_concat ]
  set_property -dict [list \
    CONFIG.IN0_WIDTH {1} \
    CONFIG.IN1_WIDTH {1} \
    CONFIG.IN2_WIDTH {1} \
  ...
  # Create instance: new_data_ready_clear_slice, and set properties
  set new_data_ready_clear_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 new_data_ready_clear_slice ]
  set_property -dict [list \
    CONFIG.DIN_FROM {2} \
    CONFIG.DIN_TO {2} \
    CONFIG.DIN_WIDTH {4} \
  ] $new_data_ready_clear_slice


  # Create instance: new_data_ready_edge, and set properties
  set block_name pulse_to_edge
  set block_cell_name new_data_ready_edge
  if { [catch {set new_data_ready_edge [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $new_data_ready_edge eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: output_buffer, and set properties
  set block_name output_buffer
  set block_cell_name output_buffer
  if { [catch {set output_buffer [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $output_buffer eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: output_buffer_synchronizer, and set properties
  set block_name output_buffer_synchronizer
  set block_cell_name output_buffer_synchronizer
  if { [catch {set output_buffer_synchronizer [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $output_buffer_synchronizer eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
\
  ...
  # Create instance: request_next_pulse, and set properties
  set block_name edge_to_pulse
  set block_cell_name request_next_pulse
  if { [catch {set request_next_pulse [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $request_next_pulse eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: request_next_slice, and set properties
  set request_next_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 request_next_slice ]
  set_property -dict [list \
    CONFIG.DIN_FROM {1} \
    CONFIG.DIN_TO {1} \
    CONFIG.DIN_WIDTH {4} \
  ...
  # Create instance: start_config_slice, and set properties
  set start_config_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 start_config_slice ]
  set_property CONFIG.DIN_WIDTH {4} $start_config_slice
  ...
  connect_bd_intf_net -intf_net AXI_arbiter_M01_AXI [get_bd_intf_pins AXI_arbiter/M01_AXI] [get_bd_intf_pins control_gpio/S_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins AXI_arbiter/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXI_arbiter/M00_AXI] [get_bd_intf_pins bitstream_gpio/S_AXI]

  # Create port connections
  connect_bd_net -net JPEG_LS_module_encoded_b [get_bd_pins JPEG_LS_module/encoded_b] [get_bd_pins output_buffer/encoded_b]
  connect_bd_net -net JPEG_LS_module_encoded_g [get_bd_pins JPEG_LS_module/encoded_g] [get_bd_pins output_buffer/encoded_g]
  connect_bd_net -net JPEG_LS_module_encoded_r [get_bd_pins JPEG_LS_module/encoded_r] [get_bd_pins output_buffer/encoded_r]
  connect_bd_net -net JPEG_LS_module_encoded_size_b [get_bd_pins JPEG_LS_module/encoded_size_b] [get_bd_pins output_buffer/encoded_size_b]
  connect_bd_net -net JPEG_LS_module_encoded_size_g [get_bd_pins JPEG_LS_module/encoded_size_g] [get_bd_pins output_buffer/encoded_size_g]
  connect_bd_net -net JPEG_LS_module_encoded_size_r [get_bd_pins JPEG_LS_module/encoded_size_r] [get_bd_pins output_buffer/encoded_size_r]
  connect_bd_net -net JPEG_LS_module_new_pixel [get_bd_pins JPEG_LS_module/new_pixel] [get_bd_pins output_buffer/new_pixel]
  connect_bd_net -net JPEG_LS_module_valid_data [get_bd_pins JPEG_LS_module/valid_data] [get_bd_pins output_buffer/valid_data]
  connect_bd_net -net Net [get_bd_ports sda] [get_bd_pins camera_config/sda]
  connect_bd_net -net Net1 [get_bd_ports scl] [get_bd_pins camera_config/scl]
  connect_bd_net -net bitstream_lsb_slice_Dout [get_bd_pins bitstream_gpio/gpio_io_i] [get_bd_pins bitstream_lsb_slice/Dout]
  connect_bd_net -net bitstream_msb_slice_Dout [get_bd_pins bitstream_gpio/gpio2_io_i] [get_bd_pins bitstream_msb_slice/Dout]
  connect_bd_net -net cam_clk_generator_clk_out1 [get_bd_ports cam_mck] [get_bd_pins cam_clk_generator/clk_out1]
  connect_bd_net -net cam_config_0_done [get_bd_pins cam_config_ila/probe1] [get_bd_pins camera_config/done] [get_bd_pins flag_concat/In3]
  connect_bd_net -net camera_connect_slice_Dout [get_bd_pins camera_connect_slice/Dout] [get_bd_pins camera_multiplexer_0/connect]
  connect_bd_net -net camera_multiplexer_0_href_out [get_bd_pins JPEG_LS_module/href] [get_bd_pins camera_ila/probe2] [get_bd_pins camera_multiplexer_0/href_out]
  connect_bd_net -net camera_multiplexer_0_pixel_out [get_bd_pins JPEG_LS_module/pixel] [get_bd_pins camera_ila/probe1] [get_bd_pins camera_multiplexer_0/pixel_out]
  connect_bd_net -net camera_multiplexer_0_vsync_out [get_bd_pins JPEG_LS_module/vsync] [get_bd_pins camera_ila/probe3] [get_bd_pins camera_multiplexer_0/vsync_out]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins cam_config_ila/clk] [get_bd_pins camera_ila/clk]
  connect_bd_net -net control_gpio_gpio2_io_o [get_bd_pins camera_connect_slice/Din] [get_bd_pins control_gpio/gpio2_io_o] [get_bd_pins new_data_ready_clear_slice/Din] [get_bd_pins request_next_slice/Din] [get_bd_pins start_config_slice/Din]
  connect_bd_net -net debounce_0_sig_out [get_bd_pins debounce_0/sig_out] [get_bd_pins reset_inverter/Op1]
  connect_bd_net -net flag_concat_dout [get_bd_pins control_gpio/gpio_io_i] [get_bd_pins flag_concat/dout]
  connect_bd_net -net href_1 [get_bd_ports href] [get_bd_pins camera_multiplexer_0/href_in]
  connect_bd_net -net new_data_ready_clear_slice_Dout [get_bd_pins new_data_ready_clear_slice/Dout] [get_bd_pins new_data_ready_edge/clear]
  connect_bd_net -net new_data_ready_edge_out_2 [get_bd_pins new_data_ready_edge/out_2] [get_bd_pins output_buffer_synchronizer/new_data_ready_1]
  connect_bd_net -net output_buffer_dout [get_bd_pins output_buffer/dout] [get_bd_pins output_buffer_synchronizer/dout_1]
  connect_bd_net -net output_buffer_end_of_data [get_bd_ports LED0] [get_bd_pins output_buffer/end_of_data] [get_bd_pins output_buffer_synchronizer/end_of_data_1]
  connect_bd_net -net output_buffer_new_data_ready [get_bd_pins new_data_ready_edge/in_1] [get_bd_pins output_buffer/new_data_ready]
  connect_bd_net -net output_buffer_read_allowed [get_bd_ports LED1] [get_bd_pins output_buffer/read_allowed] [get_bd_pins output_buffer_synchronizer/read_allowed_1]
  connect_bd_net -net output_buffer_synchronizer_dout_2 [get_bd_pins bitstream_lsb_slice/Din] [get_bd_pins bitstream_msb_slice/Din] [get_bd_pins output_buffer_synchronizer/dout_2]
  connect_bd_net -net output_buffer_synchronizer_end_of_data_2 [get_bd_pins flag_concat/In2] [get_bd_pins output_buffer_synchronizer/end_of_data_2]
  connect_bd_net -net output_buffer_synchronizer_new_data_ready_2 [get_bd_pins flag_concat/In1] [get_bd_pins output_buffer_synchronizer/new_data_ready_2]
  connect_bd_net -net output_buffer_synchronizer_read_allowed_2 [get_bd_pins flag_concat/In0] [get_bd_pins output_buffer_synchronizer/read_allowed_2]
  connect_bd_net -net output_buffer_synchronizer_request_next_1 [get_bd_pins output_buffer_synchronizer/request_next_1] [get_bd_pins request_next_pulse/in1]
  connect_bd_net -net pclk_1 [get_bd_ports pclk] [get_bd_pins JPEG_LS_module/pclk] [get_bd_pins camera_ila/probe0] [get_bd_pins camera_multiplexer_0/pclk] [get_bd_pins debounce_0/clk] [get_bd_pins new_data_ready_edge/clk_1] [get_bd_pins output_buffer/pclk] [get_bd_pins output_buffer_synchronizer/clk_1] [get_bd_pins request_next_pulse/clk]
  connect_bd_net -net pixel_1 [get_bd_ports pixel] [get_bd_pins camera_multiplexer_0/pixel_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_arbiter/ACLK] [get_bd_pins AXI_arbiter/M00_ACLK] [get_bd_pins AXI_arbiter/M01_ACLK] [get_bd_pins AXI_arbiter/S00_ACLK] [get_bd_pins bitstream_gpio/s_axi_aclk] [get_bd_pins cam_clk_generator/clk_in1] [get_bd_pins camera_config/clk] [get_bd_pins control_gpio/s_axi_aclk] [get_bd_pins new_data_ready_edge/clk_2] [get_bd_pins output_buffer_synchronizer/clk_2] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net request_next_pulse_out1 [get_bd_pins output_buffer/request_next] [get_bd_pins request_next_pulse/out1]
  connect_bd_net -net request_next_slice_Dout [get_bd_pins output_buffer_synchronizer/request_next_2] [get_bd_pins request_next_slice/Dout]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins debounce_0/sig_in]
  connect_bd_net -net reset_inverter_Res [get_bd_pins JPEG_LS_module/resetn] [get_bd_pins camera_config/resetn] [get_bd_pins camera_multiplexer_0/resetn] [get_bd_pins output_buffer/resetn] [get_bd_pins reset_inverter/Res]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_arbiter/ARESETN] [get_bd_pins AXI_arbiter/M00_ARESETN] [get_bd_pins AXI_arbiter/M01_ARESETN] [get_bd_pins AXI_arbiter/S00_ARESETN] [get_bd_pins bitstream_gpio/s_axi_aresetn] [get_bd_pins control_gpio/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net start_config_slice_Dout [get_bd_pins cam_config_ila/probe0] [get_bd_pins camera_config/start] [get_bd_pins start_config_slice/Dout]
  connect_bd_net -net vsync_1 [get_bd_ports vsync] [get_bd_pins camera_multiplexer_0/vsync_in]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports cam_pwdn] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports cam_res] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bitstream_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs control_gpio/S_AXI/Reg] -force
...
# End of cr_bd_BD_camera()
cr_bd_BD_camera ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files BD_camera.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files BD_camera.bd ] 


# Create wrapper file for BD_camera.bd
make_wrapper -files [get_files BD_camera.bd] -import -top
...
# The design that will be created by this Tcl proc contains the following 
# module references:
# HWT_cam_sim, JPEG_LS_module, edge_to_pulse, output_buffer, output_buffer_synchronizer, pulse_to_edge, debounce
  ...
  # Create instance: enable_gpio, and set properties
  set enable_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 enable_gpio ]
  set_property -dict [list \
  ...
  # Create instance: flag_gpio, and set properties
  set flag_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 flag_gpio ]
  set_property -dict [list \
    CONFIG.C_ALL_INPUTS {1} \
    CONFIG.C_ALL_OUTPUTS_2 {1} \
  ...
  # Create instance: output_buffer_synchr_0, and set properties
  set block_name output_buffer_synchronizer
  set block_cell_name output_buffer_synchr_0
  if { [catch {set output_buffer_synchr_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $output_buffer_synchr_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
\
  ...
  # Create instance: pulse_to_edge_0, and set properties
  set block_name pulse_to_edge
  set block_cell_name pulse_to_edge_0
  if { [catch {set pulse_to_edge_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pulse_to_edge_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set reset_btn [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.CLK_FREQ_MHZ {12} $reset_btn
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins enable_gpio/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins bitstream_gpio/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins flag_gpio/S_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  ...
  connect_bd_net -net HWT_cam_sim_0_pclk [get_bd_pins HWT_cam_sim_0/pclk] [get_bd_pins JPEG_LS_module_0/pclk] [get_bd_pins edge_to_pulse_0/clk] [get_bd_pins ila_0/probe0] [get_bd_pins output_buffer_0/pclk] [get_bd_pins output_buffer_synchr_0/clk_1] [get_bd_pins pulse_to_edge_0/clk_1] [get_bd_pins reset_btn/clk]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins HWT_cam_sim_0/resetn] [get_bd_pins JPEG_LS_module_0/resetn] [get_bd_pins output_buffer_0/resetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins HWT_cam_sim_0/enable] [get_bd_pins enable_gpio/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins flag_gpio/gpio2_io_o] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_3/Din]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins HWT_cam_sim_0/clk] [get_bd_pins ila_0/clk]
  connect_bd_net -net edge_to_pulse_0_out1 [get_bd_pins edge_to_pulse_0/out1] [get_bd_pins ila_0/probe1] [get_bd_pins output_buffer_0/request_next]
  connect_bd_net -net output_buffer_0_dout [get_bd_pins ila_0/probe3] [get_bd_pins output_buffer_0/dout] [get_bd_pins output_buffer_synchr_0/dout_1]
  connect_bd_net -net output_buffer_0_end_of_data [get_bd_ports LED0] [get_bd_pins output_buffer_0/end_of_data] [get_bd_pins output_buffer_synchr_0/end_of_data_1]
  connect_bd_net -net output_buffer_0_new_data_ready [get_bd_pins ila_0/probe2] [get_bd_pins output_buffer_0/new_data_ready] [get_bd_pins pulse_to_edge_0/in_1]
  connect_bd_net -net output_buffer_0_read_allowed [get_bd_ports LED1] [get_bd_pins output_buffer_0/read_allowed] [get_bd_pins output_buffer_synchr_0/read_allowed_1]
  connect_bd_net -net output_buffer_synchr_0_dout_2 [get_bd_pins output_buffer_synchr_0/dout_2] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net output_buffer_synchr_0_end_of_data_2 [get_bd_pins output_buffer_synchr_0/end_of_data_2] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net output_buffer_synchr_0_new_data_ready_2 [get_bd_pins output_buffer_synchr_0/new_data_ready_2] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net output_buffer_synchr_0_read_allowed_2 [get_bd_pins output_buffer_synchr_0/read_allowed_2] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net output_buffer_synchr_0_request_next_1 [get_bd_pins edge_to_pulse_0/in1] [get_bd_pins output_buffer_synchr_0/request_next_1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins bitstream_gpio/s_axi_aclk] [get_bd_pins enable_gpio/s_axi_aclk] [get_bd_pins flag_gpio/s_axi_aclk] [get_bd_pins output_buffer_synchr_0/clk_2] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins pulse_to_edge_0/clk_2] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pulse_to_edge_0_out_2 [get_bd_pins output_buffer_synchr_0/new_data_ready_1] [get_bd_pins pulse_to_edge_0/out_2]
  connect_bd_net -net reset_btn_sig_out [get_bd_pins reset_btn/sig_out] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins bitstream_gpio/s_axi_aresetn] [get_bd_pins enable_gpio/s_axi_aresetn] [get_bd_pins flag_gpio/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sig_in_0_1 [get_bd_ports rst] [get_bd_pins reset_btn/sig_in]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins flag_gpio/gpio_io_i] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins output_buffer_synchr_0/request_next_2] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins bitstream_gpio/gpio_io_i] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins bitstream_gpio/gpio2_io_i] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins pulse_to_edge_0/clear] [get_bd_pins xlslice_3/Dout]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs enable_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bitstream_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs flag_gpio/S_AXI/Reg] -force
...
# End of cr_bd_BD_full_test()
cr_bd_BD_full_test ""
set_property REGISTERED_WITH_MANAGER "1" [get_files BD_full_test.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files BD_full_test.bd ] 


# Create wrapper file for BD_full_test.bd
make_wrapper -files [get_files BD_full_test.bd] -import -top
...
# Create 'run_BD_full_test' run (if not found)
if {[string equal [get_runs -quiet run_BD_full_test] ""]} {
    create_run -name run_BD_full_test -part xc7z020clg400-1 -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset full_system
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs run_BD_full_test]
  set_property flow "Vivado Synthesis 2022" [get_runs run_BD_full_test]
}
set obj [get_runs run_BD_full_test]
set_property set_report_strategy_name 1 $obj
set_property report_strategy {Vivado Synthesis Default Reports} $obj
set_property set_report_strategy_name 0 $obj
# Create 'run_BD_full_test_synth_report_utilization_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs run_BD_full_test] run_BD_full_test_synth_report_utilization_0] "" ] } {
  create_report_config -report_name run_BD_full_test_synth_report_utilization_0 -report_type report_utilization:1.0 -steps synth_design -runs run_BD_full_test
}
set obj [get_report_configs -of_objects [get_runs run_BD_full_test] run_BD_full_test_synth_report_utilization_0]
if { $obj != "" } {
...
set_property -name "constrset" -value "full_system" -objects $obj
set_property -name "needs_refresh" -value "1" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/JPEG-LS-HDL.srcs/utils_1/imports/run_BD_full_test/BD_full_test_wrapper.dcp" -objects $obj
set_property -name "auto_incremental_checkpoint" -value "1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj

# Create 'run_BD_camera' run (if not found)
if {[string equal [get_runs -quiet run_BD_camera] ""]} {
    create_run -name run_BD_camera -part xc7z020clg400-1 -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset BD_camera
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs run_BD_camera]
  set_property flow "Vivado Synthesis 2022" [get_runs run_BD_camera]
}
set obj [get_runs run_BD_camera]
set_property set_report_strategy_name 1 $obj
set_property report_strategy {Vivado Synthesis Default Reports} $obj
set_property set_report_strategy_name 0 $obj
# Create 'run_BD_camera_synth_report_utilization_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs run_BD_camera] run_BD_camera_synth_report_utilization_0] "" ] } {
  create_report_config -report_name run_BD_camera_synth_report_utilization_0 -report_type report_utilization:1.0 -steps synth_design -runs run_BD_camera
}
set obj [get_report_configs -of_objects [get_runs run_BD_camera] run_BD_camera_synth_report_utilization_0]
if { $obj != "" } {
...
if {[string equal [get_runs -quiet impl_3] ""]} {
    create_run -name impl_3 -part xc7z020clg400-1 -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset full_system -parent_run run_BD_full_test
} else {
...
if {[string equal [get_runs -quiet impl_4] ""]} {
    create_run -name impl_4 -part xc7z020clg400-1 -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset BD_camera -parent_run run_BD_camera
} else {
